...
def build_random_hyper_params(args):
	...
	if args.gcn_parameters['layer_2_feats_same_as_l1'] or args.gcn_parameters['layer_2_feats_same_as_l1'].lower()=='true':
		...
		args.gcn_parameters['layer_3_feats'] = args.gcn_parameters['layer_2_feats']
		args.gcn_parameters['layer_4_feats'] = args.gcn_parameters['layer_3_feats']
	else:
...
args.gcn_parameters['layer_1_feats_min'], args.gcn_parameters['layer_1_feats_max'], type='int')
	...
	if args.gcn_parameters['lstm_l2_feats_same_as_l1'] or args.gcn_parameters['lstm_l2_feats_same_as_l1'].lower()=='true':
		...
		args.gcn_parameters['lstm_l3_feats'] = args.gcn_parameters['lstm_l2_feats']
		args.gcn_parameters['lstm_l4_feats'] = args.gcn_parameters['lstm_l3_feats']
	else:
...
def build_classifier(args,tasker):
	...
	if 'gru' in args.model or 'lstm' in args.model:
		in_feats = args.gcn_parameters['lstm_l4_feats'] * mult
	elif args.model == 'skipfeatsgcn' or args.model == 'skipfeatsegcn_h':
		in_feats = (args.gcn_parameters['layer_4_feats'] + args.gcn_parameters['feats_per_node']) * mult
	else:
		in_feats = args.gcn_parameters['layer_4_feats'] * mult
